...
#
# @main.route('/common_usermanagement', methods=['GET', 'POST'])
# @login_required
# def getcommon_usermanagement():
#     return render_template("common/usermanagement.html")
#
#
...
#                            use_unicode=True)
#     c = conn.cursor()
#     c.execute('SELECT image FROM picture WHERE id = (select max(id) from picture)')
#     result = str(c.fetchone())
#     print(result)
#     result = result[3:-3]
#     conn.close()
#     return render_template("menu3/index.html", result=result)
#
#
# # 公共配置
...
# @login_required
# def getXiaoyaoyou():
#     return render_template("common/jqgrid - 副本.html")
#
#
...
#     print('cfg')
#     print(type(cfg))
#     return render_template("common/daodejing.html", result=result)
#
#
# @main.route('/useredit')
# @login_required
# def useredit():
#     form = Useredit()
#     return render_template("common/useredit.html", form=form)
#
#
# @main.route('/useredited', methods=['GET', 'POST'])
# @login_required
# def useredited():
#     form = Useredit()
#     if form.validate_on_submit():
#         print(form.editphone.data, form.editemail.data)
#         User.update(phone=form.editphone.data, email=form.editemail.data).where(
